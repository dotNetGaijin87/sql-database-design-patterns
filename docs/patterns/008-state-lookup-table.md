...
**Script:** [`src/008_state_lookup_table.sql`](../../src/008_state_lookup_table.sql) · [Pattern index](../../README.md#the-25-patterns)
...
---
[← 007 Lookup table](007-vendor-lookup-table.md) · [Pattern index](../../README.md#the-25-patterns) · [next → 009 Enum → lookup table](009-order-status-type-lookup-table.md)
