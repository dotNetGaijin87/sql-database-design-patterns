...
**Script:** [`src/005_splitting_name_column.sql`](../../src/005_splitting_name_column.sql) · [Pattern index](../../README.md#the-25-patterns)
...
---
[← 004 Extracting sensitive columns](004-splitting-customer-table.md) · [Pattern index](../../README.md#the-25-patterns) · [next → 006 Data cleansing & format enforcement](006-simple-format.md)
