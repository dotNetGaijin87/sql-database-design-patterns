...
**Script:** [`src/011_master_detail.sql`](../../src/011_master_detail.sql) · [Pattern index](../../README.md#the-26-patterns)
...
---
[← 010 Many-to-many](010-associative-table.md) · [Pattern index](../../README.md#the-26-patterns) · [next → 012 Status history & event sourcing](012-history-table-effective-date.md)
