...
**Script:** [`src/021_denormalization_with_json.sql`](../../src/021_denormalization_with_json.sql) · [Pattern index](../../README.en.md#the-26-patterns)
...
---
[← 020 Soft delete](020-soft-delete.md) · [Pattern index](../../README.en.md#the-26-patterns) · [next → 022 Computed columns & maintained aggregates](022-computed-column.md)
