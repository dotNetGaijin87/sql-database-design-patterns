...
**Script:** [`src/015_vertical_partitioning.sql`](../../src/015_vertical_partitioning.sql) · [Pattern index](../../README.md#the-26-patterns)
...
---
[← 014 Horizontal partitioning](014-horizontal-partitioning.md) · [Pattern index](../../README.md#the-26-patterns) · [next → 016 Hierarchical data](016-modeling-hierarchical-data.md)
