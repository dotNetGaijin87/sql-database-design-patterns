...
**Script:** [`src/017_software_product_table.sql`](../../src/017_software_product_table.sql) · [Pattern index](../../README.md#the-25-patterns)
...
---
[← 016 Hierarchical data](016-modeling-hierarchical-data.md) · [Pattern index](../../README.md#the-25-patterns) · [next → 018 Subtype table + reassembly view](018-hardware-product-table.md)
