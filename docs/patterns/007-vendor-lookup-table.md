...
**Script:** [`src/007_vendor_lookup_table.sql`](../../src/007_vendor_lookup_table.sql) · [Pattern index](../../README.en.md#the-26-patterns)
...
---
[← 006 Data cleansing & format enforcement](006-simple-format.md) · [Pattern index](../../README.en.md#the-26-patterns) · [next → 008 Reference table](008-state-lookup-table.md)
