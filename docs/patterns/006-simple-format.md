...
**Script:** [`src/006_simple_format.sql`](../../src/006_simple_format.sql) · [Pattern index](../../README.en.md#the-26-patterns)
...
---
[← 005 Zero-downtime column split](005-splitting-name-column.md) · [Pattern index](../../README.en.md#the-26-patterns) · [next → 007 Lookup table](007-vendor-lookup-table.md)
