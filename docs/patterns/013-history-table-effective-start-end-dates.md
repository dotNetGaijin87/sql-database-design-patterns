...
**Script:** [`src/013_history_table_effective_start_end_dates.sql`](../../src/013_history_table_effective_start_end_dates.sql) · [Pattern index](../../README.md#the-26-patterns)
...
---
[← 012 Status history & event sourcing](012-history-table-effective-date.md) · [Pattern index](../../README.md#the-26-patterns) · [next → 014 Horizontal partitioning](014-horizontal-partitioning.md)
