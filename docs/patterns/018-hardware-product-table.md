...
**Script:** [`src/018_hardware_product_table.sql`](../../src/018_hardware_product_table.sql) · [Pattern index](../../README.md#the-26-patterns)
...
---
[← 017 Subtype table (software)](017-software-product-table.md) · [Pattern index](../../README.md#the-26-patterns) · [next → 019 Multi-language data & collations](019-handling-multilanguage-data.md)
