...
**Script:** [`src/020_soft_delete.sql`](../../src/020_soft_delete.sql) · [Pattern index](../../README.md#the-25-patterns)
...
---
[← 019 Multi-language data & collations](019-handling-multilanguage-data.md) · [Pattern index](../../README.md#the-25-patterns) · [next → 021 Denormalization with JSON](021-denormalization-with-json.md)
