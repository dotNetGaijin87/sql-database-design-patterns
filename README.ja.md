...
[![OnlineStore スキーマ（移行前）](docs/images/schema-before.png)](docs/images/schema-before.svg)
...
[![OnlineStore スキーマ（移行後）](docs/images/schema-after.png)](docs/images/schema-after.svg)
