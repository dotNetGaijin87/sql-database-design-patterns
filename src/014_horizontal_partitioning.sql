...
-- File paths use the SQL Server (Linux/Docker) default data dir; adjust for your environment.
...
(
	...
	FILENAME = '/var/opt/mssql/data/order_report_old.ndf',
		SIZE = 5 MB, 
		MAXSIZE = UNLIMITED, 
		FILEGROWTH = 5 MB
...
(
	...
	FILENAME = '/var/opt/mssql/data/order_report_2020.ndf',
		SIZE = 5 MB, 
		MAXSIZE = UNLIMITED, 
		FILEGROWTH = 5 MB
...
(
	...
	FILENAME = '/var/opt/mssql/data/order_report_2021.ndf',
		SIZE = 5 MB, 
		MAXSIZE = UNLIMITED, 
		FILEGROWTH = 5 MB
...
(
	...
	FILENAME = '/var/opt/mssql/data/order_report_2022.ndf',
		SIZE = 5 MB, 
		MAXSIZE = UNLIMITED, 
		FILEGROWTH = 5 MB
...
(
	...
	FILENAME = '/var/opt/mssql/data/order_report_2023.ndf',
		SIZE = 5 MB, 
		MAXSIZE = UNLIMITED, 
		FILEGROWTH = 5 MB
...
(
	...
	FILENAME = '/var/opt/mssql/data/order_report_2024.ndf',
		SIZE = 5 MB, 
		MAXSIZE = UNLIMITED, 
		FILEGROWTH = 5 MB
...
(
	...
	FILENAME = '/var/opt/mssql/data/order_report_2020_bad_example.ndf',
		SIZE = 5 MB, 
		MAXSIZE = UNLIMITED, 
		FILEGROWTH = 5 MB
...
(
	...
	FILENAME = '/var/opt/mssql/data/order_report_2021_bad_example.ndf',
		SIZE = 5 MB, 
		MAXSIZE = UNLIMITED, 
		FILEGROWTH = 5 MB
...
(
	...
	FILENAME = '/var/opt/mssql/data/order_report_2022_bad_example.ndf',
		SIZE = 5 MB, 
		MAXSIZE = UNLIMITED, 
		FILEGROWTH = 5 MB
